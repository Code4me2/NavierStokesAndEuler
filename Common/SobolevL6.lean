...
the support hypothesis: multiplying by the dilated cutoffs of `Common.Cutoffs`
...
`Euler/MeanCutoffCurlBound.lean`, `Euler/OrdinarySobolevL4.lean`,
`NavierStokes/R3/WeightedSobolev.lean` and `NavierStokes/R3/SmoothSobolevL6.lean`
re-export these under the names their importers use.
-/

noncomputable section

open MeasureTheory Filter Common.Cutoffs
open scoped ContDiff ENNReal NNReal Topology

namespace Common.SobolevL6
